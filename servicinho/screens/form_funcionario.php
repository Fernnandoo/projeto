...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($mysqli,"INSERT INTO tb_funcionario(nr_cpf,nm_funcionario,nm_endereco,nr_telefone,nm_bairro,nm_cidade,nr_cep) 
    VALUES ('$CPF','$nome','$endereco','$fone', '$bairro','$cidade','$cep')");
}
	else {
